...
private void tampilData(){
        int row = tbl_barang1.getRowCount();
        for(int a = 0 ; a < row ; a++){
            table.removeRow(0);
        }
    ...
    private void initComponents() {
        ...
        tbl_barang1.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        tbl_barang1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_barang1MouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tbl_barang1);
        ...
        jPanel2.setBounds(10, 60, 940, 460);
    ...
    private void tbl_barang1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_barang1MouseClicked
        
    }//GEN-LAST:event_tbl_barang1MouseClicked
